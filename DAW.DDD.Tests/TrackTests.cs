...
public class TrackTests
{
    ...
    public void SerialClipsShouldBePresent_Test()
    {
        ...
        playableEvents.ToList()[0].Event.First().Should().Be(midiEvent2); // NOTICE event 1 & 2 have switched locations to test ordering
        playableEvents.ToList()[1].Event.First().Should().Be(midiEvent1);
        playableEvents.ToList()[2].Event.First().Should().Be(midiEvent3);
        playableEvents.ToList()[3].Event.First().Should().Be(midiEvent4);

        playableEvents.ToList()[0].Location.Should().Be(location2 + clip1Location); // NOTICE event 1 & 2 have switched locations to test ordering
        playableEvents.ToList()[1].Location.Should().Be(location1 + clip1Location);
    ...
    [Fact]
    public void SerialClipsShouldBePresentAndOrdered_Test()
    {
        //Arrange & Act
        ...
        var clip1Location = Location.Create(TimeSpan.FromSeconds(10));
        var pairsClip1 = EventAtLocation<Clip>.Create(clip1Location, clip1);
        ...
        playableEvents.ToList()[0].Event.First().Should().Be(midiEvent3);
        playableEvents.ToList()[1].Event.First().Should().Be(midiEvent4);
        playableEvents.ToList()[2].Event.First().Should().Be(midiEvent2); // NOTICE event 1 & 2 have switched locations to test ordering
        playableEvents.ToList()[3].Event.First().Should().Be(midiEvent1);

        playableEvents.ToList()[0].Location.Should().Be(location3 + clip2Location);
        playableEvents.ToList()[1].Location.Should().Be(location4 + clip2Location);
        playableEvents.ToList()[2].Location.Should().Be(location2 + clip1Location);// NOTICE event 1 & 2 have switched locations to test ordering
        playableEvents.ToList()[3].Location.Should().Be(location1 + clip1Location);
    }
